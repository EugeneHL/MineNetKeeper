...
//     [self setupController:[[SceneViewController alloc]init] image:@"" selectedImage:@"" title:@"动态"];
    ...
    inforCtrl.tabBarItem = [[UITabBarItem alloc]initWithTitle:@"消息" image:image  selectedImage:selectImage];
    ...
    appCtrl.tabBarItem = [[UITabBarItem alloc]initWithTitle:@"联系人" image:image1 selectedImage:selectImage1];
    ...
    myCtrl.tabBarItem = [[UITabBarItem alloc]initWithTitle:@"动态" image:image2 selectedImage:selectImage2];
